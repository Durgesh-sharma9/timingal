  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 lg:py-16 flex flex-col items-center">
      ...
      <div className="text-center max-w-2xl mb-12">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-950/40 border border-indigo-900/50 text-indigo-300 text-xs font-semibold mb-6">
      ...
      <div className="w-full max-w-md bg-[#1e293b]/70 border border-slate-700/60 backdrop-blur-xl rounded-3xl p-6 sm:p-8 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.3)] relative overflow-hidden mb-12">
        <div className="absolute -top-12 -right-12 w-48 h-48 bg-indigo-500/5 rounded-full blur-3xl pointer-events-none" />

        <div className="flex flex-col items-center text-center space-y-6">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-indigo-500 to-purple-500 text-white flex items-center justify-center shadow-lg shadow-indigo-550/20">
          ...
          {/* Device status badge */}
          <div className="w-full bg-slate-900 border border-slate-800 rounded-2xl p-4 flex items-center justify-between text-xs">
            ...
            {devicePermissionState === 'granted' ? (
              <span className="flex items-center gap-1.5 text-emerald-400 font-semibold bg-emerald-950/40 border border-emerald-900/50 px-2.5 py-1 rounded-lg">
                <CheckCircle2 className="w-3.5 h-3.5" />
                Active
              </span>
            ) : devicePermissionState === 'denied' ? (
              <span className="flex items-center gap-1.5 text-rose-400 font-semibold bg-rose-950/40 border border-rose-900/50 px-2.5 py-1 rounded-lg">
              ...
              <button
                ...
                className="text-xs font-bold text-indigo-300 hover:text-indigo-200 bg-indigo-950/50 hover:bg-indigo-900/60 border border-indigo-900/50 px-3.5 py-1.5 rounded-lg transition-colors cursor-pointer"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-4xl">
        <div className="bg-[#1e293b]/40 border border-slate-800/60 rounded-2xl p-5 hover:border-indigo-500/20 hover:bg-[#1e293b]/70 shadow-md transition-all duration-300">
          <div className="w-9 h-9 rounded-xl bg-indigo-950 text-indigo-400 flex items-center justify-center mb-3">
            <Cpu className="w-4.5 h-4.5" />
          </div>
          <h3 className="text-slate-100 font-bold text-sm mb-1.5">WebRTC Connection</h3>
        ...
        <div className="bg-[#1e293b]/40 border border-slate-800/60 rounded-2xl p-5 hover:border-indigo-500/20 hover:bg-[#1e293b]/70 shadow-md transition-all duration-300">
          <div className="w-9 h-9 rounded-xl bg-purple-950 text-purple-400 flex items-center justify-center mb-3">
            <Video className="w-4.5 h-4.5" />
          </div>
          <h3 className="text-slate-100 font-bold text-sm mb-1.5">Socket.IO Signaling</h3>
          <p className="text-slate-400 text-xs leading-relaxed">
        ...
        <div className="bg-[#1e293b]/40 border border-slate-800/60 rounded-2xl p-5 hover:border-indigo-500/20 hover:bg-[#1e293b]/70 shadow-md transition-all duration-300">
          <div className="w-9 h-9 rounded-xl bg-pink-950 text-pink-400 flex items-center justify-center mb-3">
            <ShieldAlert className="w-4.5 h-4.5" />
          </div>
          <h3 className="text-slate-100 font-bold text-sm mb-1.5">Zero Retention Queue</h3>
          <p className="text-slate-400 text-xs leading-relaxed">
      ...
      <div className="mt-12 text-center">
        <button
          ...
          className="text-xs text-indigo-400 hover:text-indigo-300 hover:underline underline-offset-4 font-bold cursor-pointer"
        >
